...
class DTSSocket(socket.socket):
	def __init__(self, iface):
		...
		#minha interface e promiscua, porem a interface eth0 so recebera
		#na interface eth0 com eterype 0X0880
	...
	def send(self, addr, *msg_bufs):
		...
		ethertype = "\x08\x80"
		#chain
		#https://www.youtube.com/watch?v=n6D4mG4Gf7E
...
def call_dts(sock, msg_obj, msg_type):
	...
	#print("sock.id_counter.next(): %s" % str(header.id))
...
class Entity(object):
	...
	def register(self):
		...
		msg.title = self.title
		print("msg.title", msg.title)
		#print("testando juliano: ", self.title)	
		#print("testando juliano: ", msg.title)
		print("testando juliano: ", dts_pb2.ControlRequest.ETCP_ENTITY_UNREGISTER)
		print("testando juliano2: ", str(dts_pb2.ControlRequest.ETCP_ENTITY_UNREGISTER))
