...
IP_DST           = '192.168.211.102' 
IP_SRC           = '192.168.221.102'

MAC_DST          = '08:00:27:c8:f9:0d'
MAC_SRC          = '08:00:27:6f:bd:91'

SPORT            = 5170  #porta de origem
DPORT            = 2170  #porta de destino

PRO_TRA          = 0x11 #protocolo de transporte upd
...
def handle_pkt(pkt):
  ...
  if Ether in pkt:
    ...
    if pkt[Ether].type == ARQUITETURA_IPV4:
      ...
      if pkt[IP].dst == IP_SRC and pkt[IP].proto == PRO_TRA:
